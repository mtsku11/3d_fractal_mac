...
// Trimmed MIDI-only telemetry kernel for biomorph: one TelemetryCell per low-res
...
// GENERATED by tools/build_midi_telemetry.py from biomorph_raymarch.metal — the
...
// ===== DE region lifted verbatim from biomorph_raymarch.metal =====
...
kernel void biomorph_telemetry(
