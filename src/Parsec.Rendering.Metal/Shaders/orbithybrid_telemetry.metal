...
// Trimmed MIDI-only telemetry kernel for orbithybrid: one TelemetryCell per low-res
...
// GENERATED by tools/build_midi_telemetry.py from orbithybrid_raymarch.metal — the
...
// ===== DE region lifted verbatim from orbithybrid_raymarch.metal =====
...
kernel void orbithybrid_telemetry(
