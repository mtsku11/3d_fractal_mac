...
// ============================================================================
// KIFS (Kaleidoscopic IFS / Amazing IFS) distance estimator
// ============================================================================
//
// Per iteration: optional pre-rotation, abs fold into positive octant, optional
// post-rotation (the curl generator), sphere-fold inversion, scale toward pivot.
//
