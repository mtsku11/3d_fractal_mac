...
// Trimmed MIDI-only telemetry kernel for phoenix: one TelemetryCell per low-res
...
// GENERATED by tools/build_midi_telemetry.py from phoenix_raymarch.metal — the
...
// ===== DE region lifted verbatim from phoenix_raymarch.metal =====
