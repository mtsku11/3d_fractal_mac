    ...
    public static int Main(string[] args)
    {
        ...
        if (args[0] is "fluid-showcase")
        {
            ...
            try
            {
                ...
                var eyes = DeepSeaState.MakeEyeAnchors(2);   // a pair of eyes flanking the front
                ...
                for (int i = 0; i < nFrames; i++)
                {
                    ...
                    eyes.Update(p => Mbulb(p, power), 1f / fps, t);       // eyes re-stick to the morphing skin
                    prevPos = pos; prevPower = power; havePrev = true;
                    ...
                    FluidCompositor.Apply(pixels, w, h, field, cam, fovY, t, p => Mbulb(p, power),
                        ...
                        eyes: eyes, eyeSize: 1.0f, eyeGlow: 1.0f);
